...
if __name__ == "__main__":
    ...
    while model.num_timesteps < MAX_TIMESTEPS:
        ...
        if reward_mean > best_reward:
            ...
            blob = bucket.blob(f"basic_environment/reinforcementEndToEnd/models/PPO_{len(logs_folders)}_0/{model.num_timesteps}.zip")
        ...
        blob = bucket.blob(f"basic_environment/reinforcementEndToEnd/logs/PPO_{len(logs_folders)}_0/{latest_log}")
