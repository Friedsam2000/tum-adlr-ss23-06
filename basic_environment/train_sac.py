...
if __name__ == "__main__":
    ...
    n_steps = 256
    model = SAC("CnnPolicy", env, learning_rate=0.00015,verbose=1, learning_starts=30000, buffer_size=250000, optimize_memory_usage=True ,tensorboard_log="logs", device=device, batch_size=512)
