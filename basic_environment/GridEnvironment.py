...
class CustomEnv(gym.Env):
    ...
    def reset(self):
        ...
        # define observation
        observation = [self.agent_position[1], self.agent_position[0], self.goal_position[1],
    ...
    def step(self, action):
        ...
        self.old_block_positions.append(self.agent_position.copy())
        ...
        if self.agent_position == self.goal_position:
            ...
            self.reward = - distance/self.grid_size[0]
    ...
    def render(self, mode='human'):
        ...
        img[self.agent_position[1] * block_size:(self.agent_position[1] + 1) * block_size,
        self.agent_position[0] * block_size:(self.agent_position[0] + 1) * block_size] = block_color
        # draw the goal block
