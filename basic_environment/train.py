...
if __name__ == "__main__":
    ...
    model = DQN("MlpPolicy", env, policy_kwargs=policy_kwargs, verbose=1, tensorboard_log="logs", device=device, buffer_size=35000, learning_starts=30000, learning_rate=5e-5)
