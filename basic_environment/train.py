...
if __name__ == "__main__":
    ...
    n_steps = 100
    model = PPO("CnnPolicy", env, verbose=1, tensorboard_log="logs", device=device, n_steps=n_steps, learning_rate=0.00025, gamma=0.98, gae_lambda=1.0, ent_coef=0.00025, batch_size=100)
