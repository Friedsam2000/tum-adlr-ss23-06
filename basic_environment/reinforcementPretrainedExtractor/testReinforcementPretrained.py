...
# Load the model
# Note: You may need to modify custom_objects if you added any custom feature extractors or other components in your training script.
...
env = FeatureExtractedEnv(GridEnvironment(num_last_agent_pos=0, num_obstacles=6, num_frames_to_stack=4, size_grid_frame_info=7))
